...
```{r 3-04-linearRegression-1, exampleRegression, echo=FALSE,fig.width=3,fig.height=3,fig.align='center',fig.cap="A linear regression model fitted through data points.", fig.pos = "ht"}
...
```{r 3-04-linearRegression-2, lineEquation, echo=FALSE,fig.width=7,fig.height=3,fig.align='center',fig.cap="The equation of straight lines.", fig.pos = "ht"}
...
```{r 3-04-linearRegression-3, leastSquares, echo=FALSE,fig.width=4.8,fig.height=4,fig.align='center',fig.cap="Residuals and least squares: which is the best fitting line?",fig.pos = "ht"}
classData <- read.csv("CourseData/classData.csv") %>%
  filter(Year == 2019)
...
```{r 3-04-linearRegression-4, slopeHypo, echo=FALSE,fig.width=8,fig.height=3,fig.align='center',fig.cap="(A) the total variation around the overall mean Height value (B) the residual error of the model.",fig.pos = "ht"}
classData <- read.csv("CourseData/classData.csv") %>%
  filter(Year == 2019)
...
```{r 3-04-linearRegression-13, rSquared, echo=FALSE,fig.width=4,fig.height=4,fig.align='center',fig.cap="An illustration of different R-squared values.", fig.pos = "ht",cache=TRUE}
set.seed(7645)
