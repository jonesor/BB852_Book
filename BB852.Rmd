...
curl::curl_download("https://mitsdu.sdu.dk/skema/icalendar/activities/N110040101/e23/e23",
  destfile = "bb852.ics"
)
```
...
_The ANOVA results showed that maternal weight was strongly associated with the number of offspring  (Poisson GLM: Null Deviance = 166.8, Residual Deviance = 122.7, d.f. = 1 and 98, p <0.001). This indicates that there is a significant relationship between the weight of the offspring and the number of offspring produced._
...
<!--chapter:end:4_02_Past_Exam_2020.Rmd-->
...
**THIS IS A PLACE-HOLDER. THE EXAM WILL BE RELEASED HERE SOME TIME IN DECEMBER**

<!--chapter:end:5_02_Exam_December_2023.Rmd-->
