...
```{r 3-02-t-tests-1, oneSampleVis, echo=FALSE,fig.width=6,fig.height=2,fig.align='center',fig.cap ="Visualisation of a t-test."}
d1 <- c(150, 40)
d2 <- c(200, 40)
...
```{r 3-02-t-tests-2, tDist, echo=FALSE,fig.width=3,fig.height=2,fig.align='center',fig.cap="The t-distribution"}
...
```{r 3-02-t-tests-5, pollution, fig.width=4,fig.height=3,fig.align='center',fig.cap="Histogram of the pollution data."}
...
```{r 3-02-t-tests-9, pairedT,echo=FALSE,fig.width=3,fig.height=2,fig.align='center',fig.cap="Visualising a paired t-test."}
...
```{r 3-02-t-tests-11, toolData,fig.width=4.5,fig.height=3, fig.align='center',fig.cap="An interaction plot for the tool use data"}
...
```{r 3-02-t-tests-17, twosample, echo=FALSE, fig.width=6,fig.height=2,fig.align='center',fig.cap="A two-sample t-test.", fig.pos="ht"}
d1 <- c(40, 10)
d2 <- c(60, 10)
...
```{r 3-02-t-tests-19, reactionData, fig.width=4,fig.height=3,fig.align='center',fig.cap="Reaction time of both sexes", fig.pos="ht", echo = -1,cache=TRUE}
set.seed(42)
