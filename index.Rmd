...
It is available as a website (https://jonesor.github.io/BB852_Book/) or as a PDF (http://bit.ly/BB852Book). I recommend to use the website where possible because the formatting is sometimes messy on the PDF, but the PDF is useful if you want a copy for offline use.
