...
I wrote this book to accompany the course *BB852 - Data Handling, Visualisation and Statistics*.


It is available as a website (https://jonesor.github.io/BB852_Book/) or as a PDF (click the link at the top of book's website). I recommend
to use the website where possible because the formatting is sometimes messy on the PDF, but the PDF is helpful if you want a copy for offline use.
