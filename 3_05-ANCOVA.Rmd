...
Hand width and gender both explain a significant amount of the variation in height (ANCOVA - Handwidth: F =`r formatC(anova(mod_A)[[4]][1], digits = 3, format = "f")`, d.f. = 1 and `r anova(mod_A)[[1]][4]`, p<0.001; Gender: `r formatC(anova(mod_A)[[4]][2], digits = 3, format = "f")`, d.f. = 1 and `r anova(mod_A)[[1]][4]`, p<0.001). The interaction effect was not significant, which means that the slopes of the relationship between hand width and height are not significantly different (ANCOVA - `r formatC(x$"F value"[1], digits = 3, format = "f")`, d.f. = 1 and `r anova(mod_A)[[1]][4]`, p = `r formatC(anova(mod_A)[[5]][3], digits = 3,format = "f")`.
