...
For example, this code will not produce the box plot you might expect (because `sex` is a character vector, R does not know to draw a box plot):
...
I have put all the data for the course into a Dropbox folder - see the link in the Preface. In there you will find a file called "`carnivora.csv`". Download this to your new `CourseData` folder. 
