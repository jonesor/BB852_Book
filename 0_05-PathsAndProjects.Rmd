...
RStudio Projects offer an even easier way to manage file locations. When you create an R Project, RStudio automatically sets your project folder as the working directory every time you open the project.
