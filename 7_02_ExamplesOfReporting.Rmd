...
_My t-test comparing the mean height of plants in the control group and the treatment group showed that the mean height of plants in the control group was 7.2 while the mean height of plants in the treatment group was 8.2. There was no significant difference between the two groups (t-statistic = -1.6184, df = 8, p-value = 0.1431)._
...
For the methods, I might write somthing like this:
...
_The ANOVA results showed that maternal weight was strongly associated with the number of offspring  (Poisson GLM: dGLM: Null Deviance = 166.8, Residual Deviance = 122.7, d.f. = 1 and 98, p <0.001). This indicates that there is a significant relationship between the weight of the offspring and the number of offspring produced._
