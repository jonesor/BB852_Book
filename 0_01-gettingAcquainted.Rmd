...
You can download the RStudio Desktop from https://rstudio.com/products/rstudio/download/. Select the correct version for your computer (Mac/Windows) and follow the usual instructions.
...
It would be incredibly tedious to enter real data by typing it in like this. There are eas
...
```{r, fig.cap=('A simple scatter plot'), fig.show=('asis')}
